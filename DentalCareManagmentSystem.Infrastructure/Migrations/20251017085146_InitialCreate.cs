    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiagnosisNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiagnosisNotes_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DiagnosisNotes_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifiedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationLogs_AspNetUsers_NotifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentItems_PriceListItems_PriceListItemId",
                        column: x => x.PriceListItemId,
                        principalTable: "PriceListItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentItems_TreatmentPlans_TreatmentPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiagnosisNotes_DoctorId",
                table: "DiagnosisNotes",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DiagnosisNotes_PatientId",
                table: "DiagnosisNotes",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_NotifiedById",
                table: "NotificationLogs",
                column: "NotifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentItems_PriceListItemId",
                table: "TreatmentItems",
                column: "PriceListItemId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentItems_TreatmentPlanId",
                table: "TreatmentItems",
